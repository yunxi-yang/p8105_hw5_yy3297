...
Create a plot that shows the estimates and CIs for each city using geom_errorbar to add error bars based on the upper and lower limits; Also, organize cities according to the proportion of unsolved homicides in ascending orders.
